...
// - ThemeOn.net -
 ...
 $(document).ready(function() {
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#bootbox-custom-h-content').on('click', function(){
        bootbox.dialog({
            title: "That html",
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#bootbox-custom-h-form').on('click', function(){
        bootbox.dialog({
            ...
            message:'<div class="row"> ' + '<div class="col-md-12"> ' +
                    ...
                    '<label class="form-radio form-icon modal-radio active"><input type="radio" autocomplete="off" name="awesomeness" value="Really awesome" checked> Really awesome</label>' +
                    '<label class="form-radio form-icon modal-radio"><input type="radio" autocomplete="off" name="awesomeness" value="Super awesome"> Super awesome </label> </div>' +
    ...
    // =================================================================
    $('#bootbox-zoom').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#bootbox-bounce').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#bootbox-ruberwobble').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#bootbox-flip').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#bootbox-lightspeed').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#bootbox-swing').on('click', function(){
        bootbox.confirm({
