...
$(document).on('nifty.ready', function() {
    ...
    var earningSparkline = function(){
        $("#sparkline-line").sparkline([945, 754, 805, 855, 678, 987, 1026, 885, 878, 922, 875, ], {
            type: 'line',
            width: '100%',
            height: '60',
            spotRadius: 0,
    ...
    // =================================================================
    $('#panel-network-refresh').niftyOverlay({
