...
$(document).on('nifty.ready', function() {
    ...
    skycons.add("weather-md-icon-1", Skycons.PARTLY_CLOUDY_DAY);
    skycons.play();

    /* Small Icons*/
    var skycons2 = new Skycons(skyconsOptions);
    skycons2.add("weather-md-icon-2", Skycons.CLOUDY);

    var skycons3 = new Skycons(skyconsOptions);
    skycons3.add("weather-md-icon-3", Skycons.PARTLY_CLOUDY_DAY);

    var skycons4 = new Skycons(skyconsOptions);
    skycons4.add("weather-md-icon-4", Skycons.RAIN);
    ...
    /* Main Icon */
    var skycons = new Skycons(skyconsOptions);
    skycons.add("weather-lg-icon-1", Skycons.CLEAR_DAY);
    skycons.play();
    ...
    /* Small Icons*/
    var skycons2 = new Skycons(skyconsOptions);
    skycons2.add("weather-lg-icon-2", Skycons.CLOUDY);


    var skycons3 = new Skycons(skyconsOptions);
    skycons3.add("weather-lg-icon-3", Skycons.PARTLY_CLOUDY_NIGHT);


    var skycons4 = new Skycons(skyconsOptions);
    skycons4.add("weather-lg-icon-4", Skycons.RAIN);


    var skycons5 = new Skycons(skyconsOptions);
    skycons5.add("weather-lg-icon-5", Skycons.PARTLY_CLOUDY_DAY);
    ...
    var skycons = new Skycons(skyconsOptions);
    skycons.add("weather-sm-icon", Skycons.RAIN);
    skycons.play();
    ...
    skycons.add("weather-xs-icon-1", Skycons.CLEAR_DAY);
    skycons.play();
    ...
    skycons.add("weather-xs-icon-2", Skycons.PARTLY_CLOUDY_DAY);
    skycons.play();
