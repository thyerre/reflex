...
$(document).on('nifty.ready', function () {
    ...
    var areaSparklines = function () {
        $('#sparklines-area-1').sparkline([57, 69, 70, 62, 73, 79, 76, 77, 73, 52, 57, 50, 60, 55, 70, 68], {
            type: 'line',
            width: '100%',
            height: '70',
            spotRadius: 4,
    ...
    var areaSparklines_2 = function () {
        $('#sparklines-area-2').sparkline([57, 69, 70, 62, 73, 79, 76, 77, 73, 52, 57, 50, 60, 55, 70, 68], {
            type: 'line',
            width: '100%',
            height: '70',
            spotRadius: 4,
    ...
    var lineSparklines = function () {
        $('#sparklines-line-1').sparkline([945, 754, 805, 855, 678, 987, 1026, 885, 878, 922, 875, ], {
            type: 'line',
            width: '100%',
            height: '70',
            spotRadius: 3,
    ...
    var lineSparklines_2 = function () {
        $('#sparklines-line-2').sparkline([945, 754, 805, 855, 678, 987, 1026, 885, 878, 922, 875, ], {
            type: 'line',
            width: '100%',
            height: '70',
            spotRadius: 3,
