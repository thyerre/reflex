...
$(document).on('nifty.ready', function() {
    ...
    var alert_preview = $("#preview-alert").children(".alert"),
        alert_thumb = $(".thumb-alert"),
        select_layout = $("#alert-layout"),
        select_style = $("#alert-style"),
        select_animin = $("#alert-animin"),
        select_animout = $("#alert-animout"),
        select_pos = $("#alert-pos"),
        floating_label = $(".floating-label"),
        input_sticky = $("#sticky-alert"),
        input_xbtn = $("#close-btn"),
        btn_alert = $("#add-alert"),
        js_code = $("#jsout"),
        ...
        alert_content = [{
                ...
                type: '<div class="media-left"><span class="icon-wrap icon-wrap-xs icon-circle alert-icon"><i class="psi-gear icon-2x"></i></span></div><div class="media-body"><h4 class="alert-title">Server Load Limited</h4><p class="alert-message">Database server has reached its daily capicity</p></div>'
            }, {
    ...
    var onshow = $("#noty-onshow"),
        onshown = $("#noty-onshown"),
        onhide = $("#noty-onhide"),
        onhidden = $("#noty-onhidden");
